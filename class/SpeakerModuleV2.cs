...
{
    public class SpeakerModuleV2 : ISpeakerModule
    {
        private List<string> _audio = new List<string> { "dolby", "atmos", "thx", "stereo" };
        private int selection = 0;
        private readonly HashSet<string> _commands = new HashSet<string>() { "audio" };
        private readonly HashSet<int> _valid = new HashSet<int>() { 0, 1, 2, 3 };
